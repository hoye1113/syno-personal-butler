...
3. R3-0 已提交 `c34ba05`，知识闭环首轮 `3ff0484`，可靠性基线 `9a0a61a`，CognitiveRuntime `f003276`，Hermes 决策与固定 Provider 加固 `f015921`，Web 无障碍和浏览器验收 `200fb1f`，最终切换控制 `2a8d195`；主工作树和 `C:\tmp\syno-fresh-2a8d195` 均为 Node 114/114、vault 57/57、仓库校验通过。
