...
import { parseOptions as parseFeishuOptions, summarizeFeishu } from "../scripts/probe-feishu.mjs";
import { parseOptions as parseWeixinOptions, summarizeWeixin } from "../scripts/probe-weixin.mjs";
