...
- 当前验收代码基线 `3c2b362` 已在主工作树与 `C:\tmp\syno-fresh-3c2b362` 通过锁文件离线安装（下载 0）、Node 150/150、vault 57/57、同为 570 项的仓库校验和隔离冷启动。主人修复后从微信直发 MD 收到 `artifact-20260720-ac6c5d41`，后台形成 `ingest-50964b42`，未出现审批码、未写入 vault；全部发布门槛通过。
