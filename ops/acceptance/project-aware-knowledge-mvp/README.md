...
The live test uses a temporary `.runtime/tests` fixture for Project, Job, Workflow, Proposal and Vault state. It does not modify the external `deepseek-harness` checkout.
