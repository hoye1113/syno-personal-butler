...
created: 2026-06-11
source: 02-Resources/Prompts/Web Clipping/Clip Web Page.md
description: Prompt 模板：基于任意网页上下文（Obsidian Web Clipper / Web Viewer 提供）生成完整 Obsidian 笔记——含 YAML frontmatter（title/description/url）、Summary、5-8 条 Key Takeaways、Mermaid 思维导图（4 条语法约束）、3-5 条 Notable Quotes
---
